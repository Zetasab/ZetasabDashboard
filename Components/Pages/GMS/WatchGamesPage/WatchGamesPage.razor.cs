...
namespace ZetaDashboard.Components.Pages.GMS.WatchGamesPage
{
    public partial class WatchGamesPage
    {
        #region Injects
        ...
        {
            DataBup = await DController.GetData(await ApiService.WatchGames.GetAllWatchGamesByUserIdAsync(LoggedUser));
