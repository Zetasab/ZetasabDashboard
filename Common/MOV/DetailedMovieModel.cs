...
namespace ZetaDashboard.Common.MOV
{
    public class DetailedMovieModel
    {
        ...
        public string GetBackGroungUrl(string size = "w1920_and_h800_multi_faces") =>
            string.IsNullOrEmpty(BackdropPath) ? "" : $"https://image.tmdb.org/t/p/{size}{BackdropPath}";
        public string GetCollectionBackGroungUrl(string size = "w1000_and_h450_multi_faces") =>
            string.IsNullOrEmpty(BelongsToCollection.BackdropPath) ? "" : $"https://image.tmdb.org/t/p/{size}{BackdropPath}";
